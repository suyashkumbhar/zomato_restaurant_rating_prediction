...
# model = joblib.load('E:\data_science_end_to_end_projects\iNeuron_restaurant_rating_prediction_web_app\extra_trees_regressor2.joblib')
...
def main():
    ...
    input_df_processed, _ = preprocess_input(input_df)
    
    # Make prediction
    prediction = predict_rating(input_df_processed)
